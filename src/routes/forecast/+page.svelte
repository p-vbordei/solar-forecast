...
<div class="space-y-6">
	...
	<div>
		...
		<p class="text-soft-blue/60 mt-2">Generate and analyze solar production forecasts using real ML models</p>
	</div>
			...
			{:else}
				<div class="flex items-center justify-center h-96">
					<div class="text-center text-soft-blue/60">
						...
						<p class="text-sm mt-2">Generate a forecast using the controls above</p>
					</div>
				</div>
			{/if}
		</div>
				...
				<div class="card-glass">
					...
					<div class="space-y-2">
						<div class="flex items-center justify-between">
							...
							<span class="text-cyan font-mono">{forecastData.avgPower?.toFixed(1) || '0.0'} MW</span>
						</div>
						<div class="flex items-center justify-between">
							<span class="text-sm text-soft-blue">Total Energy</span>
							<span class="text-cyan font-mono">{forecastData.totalEnergy?.toFixed(1) || '0.0'} MWh</span>
						</div>
						<div class="flex items-center justify-between">
				...
				<div class="bg-gradient-to-br from-dark-petrol/60 to-teal-dark/40 rounded-xl p-6 border border-cyan/20">
					...
					<div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 text-sm">
						<div class="bg-dark-petrol/50 rounded-lg p-3 border border-cyan/30">
							...
							<div class="text-soft-blue/80 text-xs">Connected to Python ML worker for real-time forecast generation</div>
						</div>

						<div class="bg-dark-petrol/50 rounded-lg p-3 border border-cyan/30">
							<div class="text-cyan font-medium mb-1">Progress Tracking</div>
							<div class="text-soft-blue/80 text-xs">Visual progress bar with status updates during generation</div>
						</div>

						<div class="bg-dark-petrol/50 rounded-lg p-3 border border-cyan/30">
							<div class="text-cyan font-medium mb-1">Database Storage</div>
							<div class="text-soft-blue/80 text-xs">Automatic saving to TimescaleDB with confidence scoring</div>
						</div>

						<div class="bg-dark-petrol/50 rounded-lg p-3 border border-cyan/30">
							<div class="text-cyan font-medium mb-1">Weather Integration</div>
							<div class="text-soft-blue/80 text-xs">Real-time meteorological data integration for accurate predictions</div>
						</div>

						<div class="bg-dark-petrol/50 rounded-lg p-3 border border-cyan/30">
							<div class="text-cyan font-medium mb-1">Multiple Models</div>
							<div class="text-soft-blue/80 text-xs">Support for CatBoost, LSTM, and XGBoost ML models</div>
						</div>

						<div class="bg-dark-petrol/50 rounded-lg p-3 border border-cyan/30">
							<div class="text-cyan font-medium mb-1">Export Options</div>
							<div class="text-soft-blue/80 text-xs">CSV and Excel export with confidence bands and metadata</div>
						</div>
					</div>
				</div>
