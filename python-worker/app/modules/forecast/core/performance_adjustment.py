...
def apply_temperature_derating(
    ...
    # Apply derating for high temperatures
    high_temp_mask = (temp > high_temp_threshold) & (temp <= extreme_temp_threshold)
    extreme_temp_mask = temp > extreme_temp_threshold
    
    derate_factor[high_temp_mask] = high_temp_derate
    derate_factor[extreme_temp_mask] = extreme_temp_derate
